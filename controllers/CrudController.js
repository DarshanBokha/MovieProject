...
const addRecord = async(req,res) => {
    try{
        const {mname,dname,wname,aname,lang,country,type} = req.body;
        let editId = req.body.editid;
        if(editId){
            if(req.file){
                if(!mname || !dname || !wname || !aname){
                ...
                if(deleteRecord){
                    fs.unlinkSync(deleteRecord.john);
                }else{
            ...
            if(!mname || !dname || !wname || !aname || !lang || !country || !type){
                console.log("plese all field fill");
                return res.redirect('back');
            }
            let image = "";
